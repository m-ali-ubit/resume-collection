# Third party library https://github.com/glemmaPaul/django-taggit-serializer
# all credit goes to https://github.com/glemmaPaul/
# copied all the code to make some custom changes
