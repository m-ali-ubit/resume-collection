...
from resumecollection.users.models import User
from resumecollection.utils.validations import validate_existing_email


def get_user_data_by_email(email: str) -> Dict[str, Any]:
